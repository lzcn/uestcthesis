...
\begin{table}[ht]
  \centering
  \caption{表号和表题在表的正上方。每个表应有简短确切的表题，五号字，居中置于表的正上方。表题超过一行时，两端对齐，左右缩进4字符。}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.3\textwidth]{uestc-badge.pdf}
  \caption{图号、图题置于图的下方}
  \label{fig:badge}
  \note{注：图注的内容不宜放到图题中。}
\end{figure}
...
\begin{figure}[t]
  \centering
  \subfloat[]{\includegraphics[width=0.3\linewidth]{uestc-badge}}
  \subfloat[]{\includegraphics[width=0.3\linewidth]{uestc-badge}}
  \caption{图号、图题置于图的下方}
  \label{fig:badges}
\end{figure}
